...
var (
	ALICE = nostr.MustPubKeyFromHex("eadad094b75b4690e7ee7124522861b8d81d5ed92e81eb678e776d1164d1efe9")
	BOB   = nostr.MustPubKeyFromHex("6ac475cdf30e2006ee5142559544e86f8f1b485a9c8c1f2da467996fb7fcdfe7")
	CAROL = nostr.MustPubKeyFromHex("f81982b8b6ba354a1e09acfda348512ef93e5778847fb5f4b30fe6b0042f4b36")
	DEREK = nostr.MustPubKeyFromHex("24a049c4e5c9cff1764c312b2e0fa59a02af235b37809180b3f2c7b2ec3dbdfd")
)
...
func TestGroupEventBackAndForth(t *testing.T) {
	...
	require.True(t, admins2.Tags.FindWithValue("p", ALICE.Hex())[2] == "nada", "translation of group2 to admins event failed")
	require.True(t, admins2.Tags.FindWithValue("p", BOB.Hex())[2] == "nada", "translation of group2 to admins event failed")
	...
	require.NotNil(t, members2.Tags.FindWithValue("p", ALICE.Hex()), "translation of group2 to members2 event failed")
	require.NotNil(t, members2.Tags.FindWithValue("p", BOB.Hex()), "translation of group2 to members2 event failed")
	require.NotNil(t, members2.Tags.FindWithValue("p", CAROL.Hex()), "translation of group2 to members2 event failed")
	require.NotNil(t, members2.Tags.FindWithValue("p", DEREK.Hex()), "translation of group2 to members2 event failed")

	_ = group1.MergeInMembersEvent(&members2)
	...
	_ = group1.MergeInAdminsEvent(&admins2)
